...
// maiatnic.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CballisticsApp, CWinApp)
	

END_MESSAGE_MAP()


// создание CmaiatnicApp

CballisticsApp::CballisticsApp()
{
...
// Единственный объект CmaiatnicApp

CballisticsApp theApp;


// инициализация CmaiatnicApp

BOOL CballisticsApp::InitInstance()
{
